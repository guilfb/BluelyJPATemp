...
<form method="post" action="deleteOeuvrepret.htm?id=${uneOeuvrepret.idOeuvrepret}">
    <div class="col-md-12 well well-md">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <INPUT type="text" name="txttitre" value='${uneOeuvrepret.titreOeuvrepret}' id="titre" class="form-control" min="0" disabled="disabled">
            </div>
        </div>
        <div class="row" >
            <div class="col-md-12" style ="border:none; background-color:transparent; height :20px;">
